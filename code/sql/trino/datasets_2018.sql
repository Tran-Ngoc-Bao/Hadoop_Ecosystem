create table if not exists hive.datasets.cancellation_code_2018
with (format = 'parquet')
as select
Year, Quarter, Month,
...
create table if not exists hive.datasets.flight_distances_2018
with (format = 'parquet')
as select 
Year, Quarter, Month,
...
create table if not exists hive.datasets.departure_times_2018
with (format = 'parquet')
as select
Year, Quarter, Month,
...
create table if not exists hive.datasets.day_of_month_2018
with (format = 'parquet')
as select
Year, Quarter, Month,
