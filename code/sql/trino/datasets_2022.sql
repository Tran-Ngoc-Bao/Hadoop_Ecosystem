create table if not exists hive.datasets.cancellation_code_2022
with (format = 'parquet')
as select
Year, Quarter, Month,
...
create table if not exists hive.datasets.marketing_airline_network_2022
with (format = 'parquet')
as select
Year, Quarter, Month,
...
create table if not exists hive.datasets.flight_distances_2022
with (format = 'parquet')
as select 
Year, Quarter, Month,
...
create table if not exists hive.datasets.flights_across_days_of_the_week_2022
with (format = 'parquet')
as select
...
create table if not exists hive.datasets.departure_times_2022
with (format = 'parquet')
as select
Year, Quarter, Month,
...
create table if not exists hive.datasets.flight_origins_2022
with (format = 'parquet')
as select
Year, Quarter, Month,
...
create table if not exists hive.datasets.flights_cancellations_by_day_of_the_week_2022
with (format = 'parquet')
as select
Year, Quarter, Month, DayOfWeek,
...
create table if not exists hive.datasets.total_cancellations_and_flights_per_carrier_2022
with (format = 'parquet')
as select
...
(select Year, Quarter, Month, count(1) total_flights, count_if(Cancelled = 1) total_cancellations from hive.processed_data.flight_2022 group by Year, Quarter, Month) b
...
create table if not exists hive.datasets.day_of_month_2022
with (format = 'parquet')
as select
Year, Quarter, Month,
...
create table if not exists hive.datasets.mean_delay_by_aircraft_carrier_2022
with (format = 'parquet')
as select
